...
{ // Bishops
-48,-24, -2,  9, 19, 23, 26, 29, 31, 33, 39, 43, 49, 55},
{ // Rooks
-84,-43,-17, -5,  0,  5,  7, 12, 15, 18, 20, 22, 24, 26, 28},
{ // Queens
...
constexpr Score IMMOBILITY_PENALTY[2][4] = {
    {E(-20, 0), E(-12, 0), E( -6, 0), E( -2, 0)},
    {E(-45, 0), E(-30, 0), E(-18, 0), E( -7, 0)}
};
